...
> **不是又一个"套壳聊天"。小焦是一个真的会跑在你电脑上的 AI 伙伴**——能记住你、会找工具干活、能生成真视频和播客，还能**对接你下载的 N.E.K.O. 猫娘**做桌面伙伴（猫娘是开源项目，小焦只是把它融进一键启动、和你互相学习）。
...
**它不是让你"打开一个网页聊天"，而是真的住进你电脑的一个 AI 伙伴。** 你自己用本地大模型当它的大脑，给它套上人格、记忆、工具链，再插上**聊天 / 编码 / 视频 / 播客 / 音乐 / 图像**多个脑子，按需秒级切换。你点一下，它就能帮你写文件、跑命令、生成一段真·AI 视频或播客。桌面形象则是**对接你下载的 N.E.K.O. 猫娘**——小焦把它的服务融进一键启动，让猫娘做陪伴、小焦做大脑，两者会互相学习。
...
| 🐱 | **对接 N.E.K.O. 猫娘** | 小焦把**你下载的 N.E.K.O. 猫娘**融进一键启动(48911/48912)，后台学猫娘与主人的对话，猫娘懂小焦、小焦懂猫娘（`docs/neko.md`） |
...
> **说明**：猫娘**不是小焦自带的**——它是你**自己下载的开源 N.E.K.O. 项目**（`G:\moxing__xiaojiao\maoniang\N.E.K.O-main`，含 `launcher.py`）。小焦只是**集成它**：一键启动时把你的 N.E.K.O. 猫娘服务拉起、并后台学习它与你对话的记忆。猫娘负责桌面陪伴（形象/动效/语音），小焦负责本地大脑/工具，两者互相学习。

一键启动后，小焦会把**你下载的 N.E.K.O. 猫娘**服务拉起——成熟 Live2D 猫娘壳 + 小焦本地内核，两者互相学习：
