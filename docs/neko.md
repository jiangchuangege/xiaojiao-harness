...
> **一句话**：小焦桌面伙伴就是 **N.E.K.O. 猫娘**——一键启动时自动拉起猫娘的 `main_server` + `memory_server`，并后台**学习你与猫娘的对话**，让猫娘懂你的项目、小焦懂猫娘的说话方式。这是"**N.E.K.O. 的成熟 Live2D 猫娘壳 + 小焦本地内核**"。

---

## 1. 为什么要用 N.E.K.O.

小焦的桌面伙伴是 **N.E.K.O. 猫娘**，因为它：
